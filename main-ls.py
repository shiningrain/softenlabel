...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', default='0.3', type=float, help='alpha parameter in soften label')
    parser.add_argument('--num_exp', default=10, type=int, help='repeated experiment num')
    parser.add_argument('--save_dir', default='./resultdp-1010-5w-tmp', type=str, help='save_dir')
