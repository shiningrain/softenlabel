...
def run_experiments(method='labelsoft',mode='dp',lam=0.5, alpha=0.1, num_exp=10,save_dir=None,batch=500):
    ...
    for i in range(num_exp):
        ...
        for j in tqdm(range(10)):# 10 epoch
            # if mode == 'dp':
            writer = SummaryWriter(f"./tensorboard_Exp-fixalpha/{method}-{lam}-{alpha}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', default='0.35', type=float, help='alpha parameter in soften label')
